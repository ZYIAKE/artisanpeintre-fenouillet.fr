...
const SITE_NAME = 'VG Peintures et Rénovations'
const SITE_DOMAIN = 'artisanpeintre-fenouillet.fr'
const PARTNER_EMAIL = 'contact@artisanpeintre-fenouillet.fr'
...
function showError(form, submitBtn) {
  ...
  errEl.textContent = 'Une erreur est survenue. Appelez-nous directement au 05 17 94 83 78.'
}
